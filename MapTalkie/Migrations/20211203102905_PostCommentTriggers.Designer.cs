...
namespace MapTalkie.Migrations
{
    ...
    [Migration("20211203102905_PostCommentTriggers")]
    partial class PostCommentTriggers
    {
            ...
            modelBuilder.Entity("MapTalkie.DB.PostComment", b =>
                {
                    ...
                    b.Property<float>("RankDecayFactor")
                        .HasColumnType("double precision")
                        .HasColumnName("rank_decay_factor");
            ...
            modelBuilder.Entity("MapTalkie.DB.BlacklistedUser", b =>
                {
                    b.HasOne("MapTalkie.DB.User", "BlacklistedBy")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_blacklisted_users_users_blacklisted_by_id");
