...
namespace MapTalkie.Services.GeoService
{
    ...
    {
        private static Point _defaultLocation = new(37.618423, 55.751244) { SRID = 4326 };
        ...
        public Point GetDefaultLocation() => _defaultLocation;

        private class TwoGisResponse
        {
            public TwoGisResponseResult Result { get; set; } = null!;
        }

        private class TwoGisResponseResult
        {
            public List<TwoGisItem> Items { get; set; } = null!;
        }
